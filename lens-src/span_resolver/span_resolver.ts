...
export class SpanResolver {
  ...
  constructor(content: string, normalizeLineEndings: boolean = true) {
  ...
  byteToLineCol(byteOffset: number): Position {
  ...
  resolveSpan(startOffset: number, endOffset: number): Span {
